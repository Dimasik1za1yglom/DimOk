...
public interface UserService {
     ...
     * @return true if it was possible to save the user and link it to the authorization data,
     * and false if failed to save or failed to bind
     */
     ...
     * @return true if it was possible to delete the authorization data and the user himself immediately,
